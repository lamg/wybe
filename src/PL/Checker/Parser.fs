  ...
  lazy
    [| (fun (parseState: FSharp.Text.Parsing.IParseState) ->
       ...
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         ...
         Microsoft.FSharp.Core.Operators.box ((Unary { operator = _1; expr = _2 }): 'gentype_expr))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         let _1 = parseState.GetInput(1) :?> 'gentype_expr in
         let _2 = parseState.GetInput(2) :?> string in
         let _3 = parseState.GetInput(3) :?> 'gentype_expr in
         Microsoft.FSharp.Core.Operators.box ((Binary { operator = _2; left = _1; right = _3 }): 'gentype_expr))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         let _1 = parseState.GetInput(1) :?> string in
       ...
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         let _1 = parseState.GetInput(1) :?> string in
         Microsoft.FSharp.Core.Operators.box (([ _1 ]): 'gentype_signature))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         let _1 = parseState.GetInput(1) :?> 'gentype_signature in
         let _3 = parseState.GetInput(3) :?> string in
         Microsoft.FSharp.Core.Operators.box ((_3 :: _1): 'gentype_signature))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         let _1 = parseState.GetInput(1) :?> string in Microsoft.FSharp.Core.Operators.box ((_1): 'gentype_funcIdent))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         let _1 = parseState.GetInput(1) :?> string in Microsoft.FSharp.Core.Operators.box ((_1): 'gentype_funcIdent))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         let _1 = parseState.GetInput(1) :?> string in Microsoft.FSharp.Core.Operators.box ((_1): 'gentype_funcIdent))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         ...
         Microsoft.FSharp.Core.Operators.box (({ func = _2; signature = List.rev _4 }): 'gentype_typeOfDecl))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
       ...
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
         ...
         Microsoft.FSharp.Core.Operators.box ((TypeOfDecl _1): 'gentype_statement))
       (fun (parseState: FSharp.Text.Parsing.IParseState) ->
